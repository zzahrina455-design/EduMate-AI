...
export default function Register() {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen flex flex-col justify-between">
      <Head title="Daftar Akun Baru - EduMate AI" />
      ...
      <main className="max-w-md w-full mx-auto p-4 my-8" role="main">
        <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
          <div className="mb-6 text-center space-y-1">
            ...
            <p className="text-xs text-slate-500">Bergabung untuk mengakses asisten pembelajaran RAG</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              ...
              {errors.password_confirmation && (
                <p className="text-red-500 text-[11px] mt-1">{errors.password_confirmation}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={processing}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-lg text-xs transition duration-200 shadow-sm flex items-center justify-center gap-2 cursor-pointer mt-2 disabled:opacity-50"
            >
